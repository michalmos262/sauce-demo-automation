...
test.describe('Checkout', () => {
  ...
  test('TC-CH01: Missing first name shows validation error', async ({ checkoutStep1Page }) => {
  ...
  test('TC-CH02: Missing last name shows validation error', async ({ checkoutStep1Page }) => {
  ...
  test('TC-CH03: Missing postal code shows validation error', async ({ checkoutStep1Page }) => {
  ...
  test('TC-CH04: Valid info proceeds to step 2 order overview', async ({ checkoutStep1Page }) => {
  ...
  test('TC-CH05: Overview total is greater than subtotal (tax applied)', async ({ checkoutStep1Page, checkoutStep2Page }) => {
    await checkoutStep1Page.fillAndContinue(VALID_CHECKOUT_INFO);
    await expect(checkoutStep1Page.page).toHaveURL(/checkout-step-two/);
  ...
  test('TC-CH06: Finish shows confirmation page with thank-you', async ({ checkoutStep1Page, checkoutStep2Page, checkoutCompletePage }) => {
    await checkoutStep1Page.fillAndContinue(VALID_CHECKOUT_INFO);
